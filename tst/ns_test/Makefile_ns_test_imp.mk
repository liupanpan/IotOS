...
#------------------------------------------------------------------------------
#
# %full_filespec:Makefile_ns_test_imp.mk~3:makefile:kok_basa#1 %
# %version:3 %
# %derived_by:dzq92s %
# %date_modified:Tue Feb  8 15:35:56 2011 %
#
# DESCRIPTION:
# ------------
...
#
_src_dirs_ := $(_cur_module_path_)/ns_test_imp/_src
...
#
_bin_objs_ := $($(_build_)_OBJ_OUTDIR)/ns_test$(_obj_ext_)
#
