#===========================================================================
# FILE: test_shared_memory.mk
#===========================================================================
# Copyright 2007 Delphi Technologies, Inc., All Rights Reserved.
# Delphi Confidential
#---------------------------------------------------------------------------
# %full_filespec:test_shared_memory.mk~kok_basa#9:makefile:kok_aud#1 %
# %version:kok_basa#9 %
# %derived_by:jz4fpf %
# %date_modified:Tue Apr 14 15:18:39 2015 %
#---------------------------------------------------------------------------
#
#===========================================================================
...
_bin_name_ := test_shm$(_bin_ext_)
_bin_objs_ := $($(_build_)_OBJ_OUTDIR)/test_shared_memory$(_obj_ext_)
