...
# Delphi Confidential
#---------------------------------------------------------------------------
# %full_filespec:test_send.mk~kok_basa#11:makefile:kok_aud#3 %
# %version:kok_basa#11 %
# %derived_by:jz4fpf %
# %date_modified:Tue Apr 14 15:18:35 2015 %
#---------------------------------------------------------------------------
#
#===========================================================================
...
_bin_name_ := test_send$(_bin_ext_)
_bin_objs_ := $($(_build_)_OBJ_OUTDIR)/test_send$(_obj_ext_)
...
# ----------- --------
# 19-Jul-2013 Larry Piekarski Rev 10
