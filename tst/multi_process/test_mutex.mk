...
# Delphi Confidential
#---------------------------------------------------------------------------
# %full_filespec:test_mutex.mk~kok_basa#10:makefile:kok_aud#3 %
# %version:kok_basa#10 %
# %derived_by:jz4fpf %
# %date_modified:Tue Apr 14 15:18:17 2015 %
#---------------------------------------------------------------------------
#
#===========================================================================
...
_bin_name_ := test_mutex$(_bin_ext_)
_bin_objs_ := $($(_build_)_OBJ_OUTDIR)/test_mutex$(_obj_ext_)
