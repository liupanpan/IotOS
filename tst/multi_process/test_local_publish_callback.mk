#===========================================================================
# FILE: test_local_publish_callback.mk
#===========================================================================
# Copyright 2007 Delphi Technologies, Inc., All Rights Reserved.
# Delphi Confidential
#---------------------------------------------------------------------------
# %full_filespec:test_local_publish_callback.mk~kok_basa#8:makefile:kok_aud#1 %
# %version:kok_basa#8 %
# %derived_by:jz4fpf %
# %date_modified:Tue Apr 14 15:18:12 2015 %
#---------------------------------------------------------------------------
#
#===========================================================================
...
_bin_name_ := test_local_publish_callback$(_bin_ext_)
_bin_objs_ := $($(_build_)_OBJ_OUTDIR)/test_local_publish_callback$(_obj_ext_)
