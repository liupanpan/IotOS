#===========================================================================
# FILE: test_receive_only.mk
#===========================================================================
# Copyright 2007 Delphi Technologies, Inc., All Rights Reserved.
# Delphi Confidential
#---------------------------------------------------------------------------
# %full_filespec:test_receive_only.mk~kok_basa#10:makefile:kok_aud#3 %
# %version:kok_basa#10 %
# %derived_by:jz4fpf %
# %date_modified:Tue Apr 14 15:18:26 2015 %
#---------------------------------------------------------------------------
#
#===========================================================================
...
_bin_name_ := test_receive_only$(_bin_ext_)
_bin_objs_ := $($(_build_)_OBJ_OUTDIR)/test_receive_only$(_obj_ext_)
