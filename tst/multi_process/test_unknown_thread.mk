#===========================================================================
# FILE: test_unknown_thread.mk
#===========================================================================
# Copyright 2007 Delphi Technologies, Inc., All Rights Reserved.
# Delphi Confidential
#---------------------------------------------------------------------------
# %full_filespec:test_unknown_thread.mk~kok_basa#10:makefile:kok_aud#1 %
# %version:kok_basa#10 %
# %derived_by:jz4fpf %
# %date_modified:Tue Apr 14 15:18:46 2015 %
#---------------------------------------------------------------------------
#
#===========================================================================
...
_bin_name_ := test_unknown_thread$(_bin_ext_)
_bin_objs_ := $($(_build_)_OBJ_OUTDIR)/test_unknown_thread$(_obj_ext_)
...
# ----------- --------
# 19-Jul-2013 Larry Piekarski Rev 9
