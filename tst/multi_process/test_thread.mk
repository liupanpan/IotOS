...
# Delphi Confidential
#---------------------------------------------------------------------------
# %full_filespec:test_thread.mk~kok_basa#10:makefile:kok_aud#3 %
# %version:kok_basa#10 %
# %derived_by:jz4fpf %
# %date_modified:Tue Apr 14 15:18:41 2015 %
#---------------------------------------------------------------------------
#
#===========================================================================
...
_bin_name_ := test_thread$(_bin_ext_)
_bin_objs_ := $($(_build_)_OBJ_OUTDIR)/test_thread$(_obj_ext_)
