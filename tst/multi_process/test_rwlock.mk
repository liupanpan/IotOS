...
# Delphi Confidential
#---------------------------------------------------------------------------
# %full_filespec:test_rwlock.mk~kok_basa#9:makefile:kok_aud#1 %
# %version:kok_basa#9 %
# %derived_by:jz4fpf %
# %date_modified:Tue Apr 14 15:18:32 2015 %
#---------------------------------------------------------------------------
#
#===========================================================================
...
_bin_name_ := test_rwlock$(_bin_ext_)
_bin_objs_ := $($(_build_)_OBJ_OUTDIR)/test_rwlock$(_obj_ext_)
