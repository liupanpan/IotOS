 ...
 *
 * Description: Implementation of the SAL_Declare_Urgent() function.
 *
 * -----------------------------------------------------------------------*/
...
EM_FILENUM(XSAL_MSG2_MODULE_ID, 4); /* Identify file for trace/assert purposes */
