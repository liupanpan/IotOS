 ...
 *
 * %full_filespec:xsal_settings.h~6:incl:kok_basa#159 %
 * @version %version:6 %
 * @author  %derived_by:jz4fpf %
 * @date    %date_modified:Wed Sep  5 11:17:22 2012 %
 *
 *------------------------------------------------------------------------------
 *
 ...
 */
#   define SAL_I_Timer_Resolution_mS (5u)
 ...
 */
#define SAL_I_Timer_Adjust  1002
...
/**
 * Do not generate IPC replies for SAL_Send and SAL_Publish
 *    Sending process only receives notification that the message
 *    was successfully sent to the other process. Not that it was
 *    delivered to the destination thread. Other process router will
 *    generate a warning if it unable to deliver to destination thread.
 */
#   define XSAL_NO_IPC_REPLY
...
/**
 * Define limit to preallocate message buffer size (bytes allocated per messages)
 *    Overriding the default
 */
#define SAL_MAX_MESSAGE_BUF_SIZE 1024
