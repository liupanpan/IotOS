...
# Delphi Confidential
#---------------------------------------------------------------------------
# %full_filespec:test_qnx.mk~1:makefile:kok_aud#1 %
# %version:1 %
# %derived_by:dzq92s %
# %date_modified:Tue Aug 19 15:23:40 2008 %
#---------------------------------------------------------------------------
#
# DESCRIPTION:
# ------------
...
_src_dirs_ := $(_cur_module_path_)/common_src\
              $(_cur_module_path_)/test_qnx_src
...
#
_lib_objs_ := $($(_build_)_OBJ_OUTDIR)/em_stub$(_obj_ext_)       \
