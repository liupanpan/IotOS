#==============================================================================
# FILE: Makefile_convert_8859_1_to_utf8.mk
#
#------------------------------------------------------------------------------
#
...
#------------------------------------------------------------------------------
#
# %full_filespec: Makefile_convert_8859_1_to_utf8.mk~kok_inf#2:makefile:kok_basa#1 %
# %version: kok_inf#2 %
# %derived_by: wzj1t9 %
# %date_modified: Mon Apr 28 12:13:35 2014 %
#
# DESCRIPTION:
# ------------
...
#
_lib_name_ := convert_8859_1_to_utf8
#
...
#
_lib_objs_ :=\
   $($(_build_)_OBJ_OUTDIR)/convert_8859_1_to_utf8$(_obj_ext_)\
