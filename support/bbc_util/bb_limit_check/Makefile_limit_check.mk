...
#------------------------------------------------------------------------------
#
# %full_filespec: Makefile_limit_check.mk~kok_inf#2:makefile:kok_basa#1 %
# %version: kok_inf#2 %
# %derived_by: wzj1t9 %
# %date_modified: Mon Apr 28 12:14:09 2014 %
#
# DESCRIPTION:
# ------------
...
#
_lib_objs_ :=\
   $($(_build_)_OBJ_OUTDIR)/limit_check$(_obj_ext_)\
