#==============================================================================
# FILE: Makefile_low_pass_filter.mk
#
#------------------------------------------------------------------------------
#
...
#------------------------------------------------------------------------------
#
# %full_filespec: Makefile_low_pass_filter.mk~kok_inf#2:makefile:kok_basa#1 %
# %version: kok_inf#2 %
# %derived_by: wzj1t9 %
# %date_modified: Mon Apr 28 12:14:14 2014 %
#
# DESCRIPTION:
# ------------
...
#
_lib_objs_ :=\
   $($(_build_)_OBJ_OUTDIR)/low_pass_filter$(_obj_ext_)\
