...
#------------------------------------------------------------------------------
#
# %full_filespec: Makefile_hex_string.mk~kok_inf#2:makefile:kok_basa#1 %
# %version: kok_inf#2 %
# %derived_by: wzj1t9 %
# %date_modified: Mon Apr 28 12:13:45 2014 %
#
# DESCRIPTION:
# ------------
...
#
_lib_objs_ :=\
   $($(_build_)_OBJ_OUTDIR)/hex_string$(_obj_ext_)\
