#==============================================================================
# FILE: Makefile_byte_data_buffer.mk
#
#------------------------------------------------------------------------------
#
...
#------------------------------------------------------------------------------
#
# %full_filespec: Makefile_byte_data_buffer.mk~kok_inf#2:makefile:kok_basa#1 %
# %version: kok_inf#2 %
# %derived_by: wzj1t9 %
# %date_modified: Mon Apr 28 12:13:29 2014 %
#
# DESCRIPTION:
# ------------
...
#
_lib_objs_ :=\
   $($(_build_)_OBJ_OUTDIR)/byte_data_buffer$(_obj_ext_)\
...
ifeq (,$($(_build_)_string_resource_lib))
	$(_build_)_string_resource_lib := string_resource$(_lib_ext_) 
endif
#
...
_lib_libs_  := \
    ...
    $($(_build_)_LIB_OUTDIR)/$(_lib_prefix_)$($(_build_)_string_resource_lib)  \
