#==============================================================================
# FILE: Makefile_cpp_char_utils.mk
#
#------------------------------------------------------------------------------
#
...
#------------------------------------------------------------------------------
#
# %full_filespec: Makefile_cpp_char_utils.mk~1:makefile:kok_basa#1 %
# %version: 1 %
# %derived_by: czhswm %
# %date_modified: Wed Jul 17 14:17:46 2013 %
#
# DESCRIPTION:
# ------------
...
#
_lib_objs_ :=\
   $($(_build_)_OBJ_OUTDIR)/char_utils$(_obj_ext_)\
