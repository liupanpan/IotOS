/*===========================================================================*/
/**
 * @file dbg_trace_c99_store.c
 *
 *   Implements dbg_trace "storage" callouts for C99.
 *
 * %full_filespec:dbg_trace_c99_store.c~kok_inf#9:csrc:kok_basa#1 %
 * @version %version:kok_inf#9 %
 * @author  %derived_by:gzt3xl %
 * @date    %date_modified:Mon Feb 24 16:16:33 2014 %
 *
 *------------------------------------------------------------------------------
 *
...
void Tr_Store_Compact_Data(FILE* fp, Tr_Compact_Data_T const *tr_data)
{
   ...
   Tr_Snprintf_Compact(trace_output, DBG_TRACE_MAX_LINE_LENGTH, tr_data);
                            ...
                            va_list arg_ptr)
 {
    ...
    Tr_Snprintf_Verbose(trace_output, DBG_TRACE_MAX_LINE_LENGTH,
 ...
 *   - Renamed file from dbg_trace_printf.c to dbg_trace_c99_store.c
 *
 * - 03-Oct-2013 Kirk Bailey REV 8
 *   - Fixed order of revision history comments - no functional changes
 *   - Eliminate revision history prior to 2011
 *
 * - 24-Feb-2014 Paul Casto REV 9
