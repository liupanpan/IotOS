...
#------------------------------------------------------------------------------
#
# %full_filespec:dbg_trace_c99.mk~kok_inf#5:makefile:kok_aud#1 %
# %version:kok_inf#5 %
# %derived_by:dzq92s %
# %date_modified:Thu Oct  3 10:15:56 2013 %
#
# DESCRIPTION:
# ------------
...
#
_src_dirs_ := $(_cur_module_path_)/bb_dbg_trace_c99_imp/_src
...
#
# Turn off strict C89 ANSI checks since the module uses some of the C99
# extensions to the C language.
#
ifeq ($(_flavor_),uitron_arm_rvct)
  $(_lib_objs_):CC_$(_build_)_WARN:=
...
ifeq ($(_flavor_),win32_gcc)
  $(_lib_objs_):CC_$(_build_)_WARN:=-Wall
endif
...
# + Created from Makefile_bb_dbg_trace_c99_imp.mk.
#
# 09-may-2011 Kris Boultbee
# + Added dbg_trace_c99_log and dbg_trace_c99_store files
#
