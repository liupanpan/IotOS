/*===========================================================================*/
/**
 * @file dbg_trace_c89_log.c
 *
 *   Implements dbg_trace logging to the final output sink(s).
 *
 * %full_filespec:dbg_trace_c89_log.c~kok_inf#4:csrc:kok_basa#1 %
 * @version %version:kok_inf#4 %
 * @author  %derived_by:dzq92s %
 * @date    %date_modified:Wed Feb 26 13:09:14 2014 %
 *
 *------------------------------------------------------------------------------
 *
...
void Tr_Log(FILE* fp, char_t * trace_output)
{
    ...
    * dbg_trace_c99_log.c. Any changes made here must be investigated in
    * the other file.
   \*========================================================================*/
#if defined(DBG_ENABLE_SYSLOG)
#  if defined(QNX_NTO)
