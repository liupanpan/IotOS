...
#------------------------------------------------------------------------------
#
# %full_filespec:c89_trace_fmt.mk~kok_inf#2:makefile:kok_aud#1 %
# %version:kok_inf#2 %
# %derived_by:dzq92s %
# %date_modified:Thu Oct  3 10:00:52 2013 %
#
# DESCRIPTION:
# ------------
...
# + Created file for building a library with only the format functions.
#
