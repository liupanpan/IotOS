#ifndef DBG_TRACE_C89_H
#   define DBG_TRACE_C89_H
/*===========================================================================*/
/**
 * @file dbg_trace_c89.h
 *
 *   API for the debug trace support routines using the C standard library.
 *
 * %full_filespec:dbg_trace_c89.h~kok_inf#4:incl:kok_aud#1 %
 * @version %version:kok_inf#4 %
 * @author  %derived_by:dzq92s %
 * @date    %date_modified:Thu Oct  3 09:58:34 2013 %
 *
 *------------------------------------------------------------------------------
 *
 ...
 *   - none
 *
 * @defgroup dbg_trace_c89 Debug Trace Support for C89 Compilers
 * @{
 */
/*==========================================================================*/
 ...
 *
 * @return Number of bytes written to buffer; negative value one error.
 *
 ...
 */
int32_t Tr_Sprintf_Compact(char_t *buf, size_t buf_size,
