...
/*===========================================================================*/
/**
 * @file bb_reuse_qnx_api/reuse.h
 *
 * Declares base types required by the Delphi C Coding Standards for
 * the QNX tools.
 *
 * %full_filespec:reuse.h~kok_inf#12:incl:kok_aud#31 %
 * @version %version:kok_inf#12 %
 * @author  %derived_by:dzq92s %
 * @date    %date_modified:Mon Aug 25 13:04:07 2014 %
 *
 *------------------------------------------------------------------------------
 *
 ...
 *
 * @defgroup reuse_qnx Base type declarations for QNX.
 * @{
 */
/*==========================================================================*/
 ...
 *
 * - 25-Aug-2014 Kirk Bailey Rev. 12
 *   - Eliminated previous history which was incomplete.
 *   - Added include of limits.h for SSIZE_MAX.
 */
/*===========================================================================*/
/** @} doxygen end group */
#endif /* REUSE_H */
